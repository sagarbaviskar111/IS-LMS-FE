...
// theme — otherwise a dark-mode visitor sees a flash of the light page.
...
export const metadata: Metadata = {
  title: "InstituteSathi",
  description: "Manage students, teachers, telecallers, and admins in one place.",
};
